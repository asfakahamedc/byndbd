...
export const metadata: Metadata = {
  title: 'Cancellation Policy — Beyndesh',
      ...
      <Container className="pt-24 md:pt-32">
        <div className="max-w-3xl mx-auto flex flex-col space-y-12">
          ...
          <div className="prose prose-lg text-[#4A4A4A] font-body prose-headings:font-heading prose-headings:font-bold prose-headings:uppercase prose-headings:text-[#1A1A1A] max-w-none">
            ...
            <h2>Force Majeure</h2>
            <p>If Beyndesh cancels a trip due to security concerns, severe weather, or unnavigable rivers, you will receive a 100% refund or the option to reschedule.</p>
          </div>
        </div>
      </Container>
    </div>
