      ...
      <Container className="pt-24 md:pt-32">
        <div className="max-w-3xl mx-auto flex flex-col space-y-12">
          ...
          <div className="prose prose-lg text-[#4A4A4A] font-body prose-headings:font-heading prose-headings:font-bold prose-headings:uppercase prose-headings:text-[#1A1A1A] prose-a:text-[#FF5F0F] max-w-none">
            ...
            <h2>5. Your Rights</h2>
            <p>You have the right to request access to the personal data we hold about you and ask that it be corrected or deleted. Contact us at privacy@beyndesh.com.</p>
          </div>
        </div>
      </Container>
    </div>
